...
BEGIN
	...
	SELECT @xmlResult=(select (select C.*,(select C.Id,c.Name,c.ParentCategoryId from dbo.Category C where c.Deleted='false' FOR XML PATH ('CategoryList'),ROOT('ParentCategoryList'), Type),
