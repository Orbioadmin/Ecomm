...
ALTER TABLE [dbo].[Product_ProductVarientValue_PriceComponent_Mapping]  WITH CHECK ADD  CONSTRAINT [FK_Product_ProductVarientValue_PriceComponent_Mapping_PriceComponent] FOREIGN KEY([Id])
