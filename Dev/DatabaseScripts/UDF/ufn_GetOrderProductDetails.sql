...
BEGIN 
	   DECLARE @xmlResult xml;
		...
		SELECT @xmlResult = ( Select prd.Id,prd.Sku,prd.Name,prd.GiftCharge,prd.IsFreeShipping,prd.AdditionalShippingCharge,pic.RelativeUrl  as 'ImageRelativeUrl' from OrderItem ori inner join [Order] ord on ori.OrderId = ord.Id
