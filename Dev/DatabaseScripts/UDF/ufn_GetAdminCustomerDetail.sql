/*
 ===================================================================================================================================================
 Author:  Sankar T S
 Create date: 18 Aug 2015
 Description: This function will return the order Customer detail
 ===================================================================================================================================================  
*/
...
BEGIN 
	   DECLARE @xmlResult xml;
		...
		--WITH XMLNAMESPACES ('http://schemas.datacontract.org/2004/07/Orbio.Core.Domain.Customer' AS ns)
