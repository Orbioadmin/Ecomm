...
BEGIN 
	   DECLARE @xmlResult xml;
		...
		SELECT @xmlResult = ( select SAO.SpecificationAttributeId 'SpecificationAttributeId',SA.Name 'SpecificationAttributeName',SAO.Id 'SpecificationAttributeOptionId' ,SAO.Name 'SpecificationAttributeOptionName' from dbo.Product product 
