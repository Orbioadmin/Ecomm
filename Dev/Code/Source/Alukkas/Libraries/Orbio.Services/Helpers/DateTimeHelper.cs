...
namespace Orbio.Services.Helpers
{
    ...
    public partial class DateTimeHelper : IDateTimeHelper
    {
        ...
        private readonly DateTimeSettings _dateTimeSettings = new DateTimeSettings();
        private readonly IStoreContext store;
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public virtual TimeZoneInfo GetCustomerTimeZone(Customer customer)
        {
            ...
            if (_dateTimeSettings.AllowCustomersToSetTimeZone)
            {
                ...
                if (customer != null)
                    timeZoneId = customer.GetAttribute<string>(SystemCustomerAttributeNames.TimeZoneId, 1);
        ...
        public virtual TimeZoneInfo CurrentTimeZone
        {
            ...
            set
            {
                ...
                _genericAttributeService.SaveGenericAttributes(_workContext.CurrentCustomer.Id, "Customer", SystemCustomerAttributeNames.LastContinueShoppingPage, System.Web.HttpContext.Current.Request.UrlReferrer.PathAndQuery, 1);
            }
        }
    }
}
