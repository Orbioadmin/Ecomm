...
namespace Orbio.Web.UI.Areas.Admin
{
    public static class MappingExtensions
    {
        ...
        public static Orbio.Core.Domain.Admin.Product.Product ToDomainModel(this Product model)
        {
            Mapper.CreateMap<Product, Orbio.Core.Domain.Admin.Product.Product>()
                 .ForMember(ev => ev.Id, m => m.MapFrom(a => a.Id))
                .ForMember(ev => ev.Name, m => m.MapFrom(a => a.Name))
                .ForMember(ev => ev.ShortDescription, m => m.MapFrom(a => a.ShortDescription))
        ...
        #region Discount
        public static Orbio.Core.Domain.Discounts.Discount ToEntity(this DiscountModel entity)
        {

            Mapper.CreateMap<DiscountModel, Orbio.Core.Domain.Discounts.Discount>()
                 .ForMember(ev => ev.Id, m => m.MapFrom(a => a.Id))
                .ForMember(ev => ev.Name, m => m.MapFrom(a => a.Name))
