...
{
    public class ShoppingCartProductDetailModel : ProductOverViewModel
    {
        public ShoppingCartProductDetailModel()
        {
 
        }
        public ShoppingCartProductDetailModel(ShoppingCartProduct productDetail)
        {
            ...
            this.SelectedQuantity = productDetail.CartQuantity;
