    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        protected virtual void SetCustomerCookie(Guid customerGuid)
        {
            if (httpContext != null && httpContext.Response != null)
            {
                ...
                httpContext.Response.Cookies.Remove(CustomerCookieName);
            ...
            get
            {
               ...
               // Customer customer = null;
                ...
                if (httpContext == null || httpContext is FakeHttpContext)
                {
                    ...
                    checkBackgroundTask = true;
                }

                //check whether request is made by a search engine
                //in this case return built-in customer record for search engines 
                //or comment the following two lines of code in order to disable this functionality
                var isSearchEngine = webHelper.IsSearchEngine(httpContext);
                ...
                //}
                var authenticatedUserData = authenticationService.GetAuthenticatedCustomerData();
                //TODO: Madhu : skipping this for now
                ...
                //if (customer == null || customer.Deleted || !customer.Active)
                //{
                string customerCookieGuid = null;
                    ...
                    if (customerCookie != null && !String.IsNullOrEmpty(customerCookie.Value))
                    {
                        ...
                        if (Guid.TryParse(customerCookie.Value, out customerGuid))
                        {
                            ...
                            customerCookieGuid = customerGuid.ToString();
                        }
                    }
                //}

                //skip this since its done in sp
                ...
                //}
                 ...
                 var customer = customerService.GetCurrentCustomer(checkBackgroundTask, isSearchEngine, authenticatedUserData, customerCookieGuid, webHelper.GetCurrentIpAddress());
                //validation
