    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            if (dataProviderSettings != null && dataProviderSettings.IsValid())
            {
                ...
                if (dataProviderSettings.RawDataSettings.ContainsKey("OrbioContext") && dataProviderSettings.RawDataSettings["OrbioContext"].ToLowerInvariant().Equals("true"))
                {
                    builder.Register<IDbContext>(c => new NopPlainObjectContext(dataProviderSettings.DataConnectionString)).InstancePerHttpRequest();
                }
                else
                {
