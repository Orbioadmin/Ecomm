...
namespace Nop.Core.Infrastructure.DependencyManagement
{
    ...
    public class ContainerConfigurer
    {
        public virtual void Configure(IEngine engine, ContainerManager containerManager, EventBroker broker, NopConfig configuration)
        {
            ...
            {
                var drTypes = (configuration.ProbingRequired.ContainsKey("DependencyRegistrar") && configuration.ProbingRequired["DependencyRegistrar"]) ? typeFinder.FindClassesOfType<IDependencyRegistrar>() : configuration.DependencyRegistrarTypes;
